        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 3.5NoUnits,
                    r = 0.0NoUnits,
                    A = 9.999999999999999e-22 * (1.1e5Pa^(-7 // 2) / s),
                    E = 530.0e3J / mol,
                    V = 14.0e-6m^3 / mol,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 3.5NoUnits,
                    r = 0.0NoUnits,
                    A = 9.999999999999999e-22 * (7.440446357925734e7Pa^(-7 // 2) / s),
                    E = 530.0e3J / mol,
                    V = 14.0e-6m^3 / mol,
                    Apparatus = AxialCompression,
                ),
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 3.5NoUnits,
                    A = 9.999999999999999e-22 * (90Pa^(-7 // 2) / s),
                    E = 480.0e3J / mol,
                    V = 11.0e-6m^3 / mol,
                    r = 1.2NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 2.25NoUnits,
                    A = 3.16227766016838e-14 * (3.5e-2Pa^(-9 // 4) / s),
                    E = 212.0e3J / mol,
                    V = 0m^3 / mol,
                    r = 0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 3.05NoUnits,
                    A = 5.011872336272755e-19 * (6.0e-2Pa^(-61 // 20) / s),
                    E = 276.0e3J / mol,
                    V = 0m^3 / mol,
                    r = 0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 4.7NoUnits,
                    A = 6.309573444801891e-29 * (8Pa^(-47 // 10) / s),
                    E = 485.0e3J / mol,
                    V = 0m^3 / mol,
                    r = 0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 4.2NoUnits,
                    A = 6.309573444801891e-26 * (1.4e4Pa^(-21 // 5) / s),
                    E = 445.0e3J / mol,
                    V = 0m^3 / mol,
                    r = 0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 2.3NoUnits,
                    A = 1.584893192461117e-14 * (1 * exp10(-3.5)Pa^(-23 // 10) / s),
                    E = 154.0e3J / mol,
                    V = 0m^3 / mol,
                    r = 0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 3.2NoUnits,
                    A = 6.309573444801891e-20 * (3.27e-4Pa^(-16 // 5) / s),
                    E = 238.0e3J / mol,
                    V = 0m^3 / mol,
                    r = 0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 3.5NoUnits,
                    A = 9.999999999999999e-22 * (1600.0Pa^(-7 // 2) / s),
                    E = 520.0e3J / mol,
                    V = 11.0e-6m^3 / mol,
                    r = 1.2NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 2.3NoUnits,
                    A = 1.584893192461117e-14 * (uconvert(Pa^(-23 // 10) / s, 3.2e-4Pa^(-23 // 10) / s)),
                    E = 154.0e3J / mol,
                    V = 0m^3 / mol,
                    r = 0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 4.0NoUnits,
                    A = 9.999999999999999e-25 * (2.0e3Pa^(-4) / s),
                    E = 471.0e3J / mol,
                    V = 0.0m^3 / mol,
                    r = 0.0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 3.2NoUnits,
                    A = 6.309573444801891e-20 * (1.25e-9Pa^(-3.2) / s),
                    E = 123.0e3J / mol,
                    V = 0.0m^3 / mol,
                    r = 0.0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 2.7NoUnits,
                    A = 6.309573444801891e-17 * ((10^6.7)Pa^(-27 // 10) / s),
                    E = 670.0e3J / mol,
                    V = 0.0m^3 / mol,
                    r = 3.0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 4.7NoUnits,
                    A = 6.309573444801891e-29 * ((10^9.8)Pa^(-47 // 10) / s),
                    E = 760.0e3J / mol,
                    V = 0.0m^3 / mol,
                    r = 0.0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    Name = "Dry Clinopyroxene | Bystricky & Mackwell (2001)",
                    n = 4.7NoUnits,
                    A = 6.309573444801891e-29 * ((10^10.8)Pa^(-47 // 10) / s),
                    E = 760.0e3J / mol,
                    V = 0.0m^3 / mol,
                    r = 0.0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 3.5NoUnits,
                    A = 9.999999999999999e-22 * ((10^-2)Pa^(-7 // 2) / s),
                    E = 310.0e3J / mol,
                    V = 0.0m^3 / mol,
                    r = 0.0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 3.7NoUnits,
                    A = 6.309573444801891e-23 * ((10^-3.3)Pa^(-37 // 10) / s),
                    E = 326.0e3J / mol,
                    V = 0.0m^3 / mol,
                    r = 0.0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 4.0NoUnits,
                    A = 9.999999999999999e-25 * ((10^-11.2)Pa^(-4) / s),
                    E = 135.0e3J / mol,
                    V = 0.0m^3 / mol,
                    r = 1.0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 2.8NoUnits,
                    A = 1.584893192461124e-17 * ((10^-5.415)Pa^(-14 // 5) / s),
                    E = 184.0e3J / mol,
                    V = 0.0m^3 / mol,
                    r = 0.0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 2.8NoUnits,
                    A = 1.584893192461124e-17 * ((10^-5.045)Pa^(-14 // 5) / s),
                    E = 163.0e3J / mol,
                    V = 0.0m^3 / mol,
                    r = 0.0NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 3.5NoUnits,
                    A = 9.999999999999999e-22 * ((10^-9.3)Pa^(-7 // 2) / s),
                    E = 118.0e3J / mol,
                    V = 2.59e-6m^3 / mol,
                    r = 0.49NoUnits,
                    Apparatus = AxialCompression,
        ...
        (
            ...
            (
                DislocationCreep(;
                    ...
                    n = 2.1NoUnits,
                    A = 2.511886431509572e-13 * ((10^-6.36)Pa^(-21 // 10) / s),
                    E = 94.0e3J / mol,
                    V = 1.44e-6m^3 / mol,
                    r = 0.2NoUnits,
                    Apparatus = AxialCompression,
