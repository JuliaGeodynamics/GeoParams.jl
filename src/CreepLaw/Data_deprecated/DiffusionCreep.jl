        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    A = 1e-06 * (2.070729911135297e-7Pa^(-1) * m^3 * s^(-1)), # material specific rheological parameter
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    r = 0.0NoUnits,                         # exponent of water-fugacity
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 1e-06 * ((10^12.1)Pa^(-1) * m^(3) * s^(-1)), # material specific rheological parameter
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 1e-06 * ((10^4.7)Pa^(-1) * m^(3) * s^(-1)), # material specific rheological parameter
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    r = 1.0NoUnits,                         # exponent of water-fugacity
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 1e-06 * ((10^7.4)Pa^(-1) * m^(3) * s^(-1)), # material specific rheological parameter
                    E = 375.0e3J / mol,                        # activation energy
                    V = 20.0e-6m^3 / mol,                       # activation Volume
                    Apparatus = AxialCompression,
                ),
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    r = 0.0NoUnits,                         # exponent of water-fugacity
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 1e-06 * ((10^9.2)Pa^(-1) * m^(3) * s^(-1)), # material specific rheological parameter
                    E = 375.0e3J / mol,                        # activation energy
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    r = 0.0NoUnits,                         # exponent of water-fugacity
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 3.981071705534986e-09 * ((10^10.3)Pa^(-7 // 5) * m^(3) * s^(-1)), # material specific rheological parameter
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    r = 0.0NoUnits,                         # exponent of water-fugacity
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 1e-06 * (((10^25.3) / 64.9e3)Pa^(-1) * m^(3) * s^(-1)), # material specific rheological parameter
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 1e-06 * ((10^7.9 / 64.9e3)Pa^(-1) * m^(3) * s^(-1)), # material specific rheological parameter
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    r = 0.0NoUnits,                         # exponent of water-fugacity
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 1e-06 * ((10^15.1)Pa^(-1) * m^(3) * s^(-1)), # material specific rheological parameter
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    r = 0.0NoUnits,                         # exponent of water-fugacity
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 1e-06 * ((10^14)Pa^(-1) * m^(3) * s^(-1)), # material specific rheological parameter
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    r = 0.0NoUnits,                         # exponent of water-fugacity
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 1e-06 * ((10^8.1)Pa^(-1) * m^(3) * s^(-1)), # material specific rheological parameter
                    E = 528.0e3J / mol,                        # activation energy
                    V = 0.0m^3 / mol,                       # activation Volume
                    Apparatus = AxialCompression,
                ),
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    r = 0.0NoUnits,                         # exponent of water-fugacity
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 1e-06 * ((10^1.7)Pa^(-1) * m^(3) * s^(-1)), # material specific rheological parameter
        ...
        (
            ...
            (
                DiffusionCreep(;
                    ...
                    r = 1.0NoUnits,                         # exponent of water-fugacity
                    p = -3.0NoUnits,                        # grain size exponent
                    A = 1e-06 * ((10^-0.7)Pa^(-1) * m^(3) * s^(-1)), # material specific rheological parameter
