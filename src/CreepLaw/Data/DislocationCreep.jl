...
function serpentinite_Raleigh_1965()
    ...
    data = DislocationCreep(;
        ...
        n = 2.8NoUnits,
        A = 1.584893192461124e-17 * (6.3e-7Pa^(-14 // 5) / s),
        E = 66.0e3J / mol,
        V = 0m^3 / mol,
        r = 0NoUnits,
        Apparatus = AxialCompression,
...
function granite_Carter_1987()
    ...
    data = DislocationCreep(;
        ...
        n = 3.3NoUnits,
        A = 1.584893192461124e-20 * (1.0 * exp10(-5.7)Pa^(-33 // 10) / s),
        E = 186.5e3J / mol,
        V = 0m^3 / mol,
        r = 0NoUnits,
        Apparatus = AxialCompression,
...
function dry_quartzite_Jaoul_1984()
    ...
    data = DislocationCreep(;
        ...
        n = 2.8NoUnits,
        A = 1.584893192461124e-17 * ((2.8899e-3)Pa^(-14 // 5) / s),
        E = 184.0e3J / mol,
        V = 0.0m^3 / mol,
        r = 0.0NoUnits,
        Apparatus = AxialCompression,
...
function wet_quartzite_Jaoul_1984()
    ...
    data = DislocationCreep(;
        ...
        n = 1.4NoUnits,
        A = 1.584893192461124e-17 * ((104.957e-3)Pa^(-14 // 5) / s),
        E = 146.44e3J / mol,
        V = 0.0m^3 / mol,
        r = 0.0NoUnits,
        Apparatus = AxialCompression,
...
function wet_quartzite_Lu_2019()
    ...
    data = DislocationCreep(;
        ...
        n = 4.0NoUnits,
        A = 6.309573444801891e-41 * ((6.0e-15)Pa^(-67 // 10) / s),
        E = 132.0e3J / mol,
        V = 35.3e-6m^3 / mol,
        r = 2.7NoUnits,
        Apparatus = AxialCompression,
