...
function quartz_diorite_HansenCarter_1982()
    ...
    data = DislocationCreep(;
        ...
        n = 2.25NoUnits,
        A = 3.1622776601683796e-14 * (3.5e-2Pa^(-9 // 4) / s),
        E = 212e3J / mol,
        V = 0m^3 / mol,
        r = 0NoUnits,
        Apparatus = AxialCompression,
...
function diabase_Caristan_1982()
    ...
    data = DislocationCreep(;
        ...
        n = 3.05NoUnits,
        A = 5.0118723362727554e-19 * (6.12e-2Pa^(-61 // 20) / s),
        E = 276e3J / mol,
        V = 0m^3 / mol,
        r = 0NoUnits,
        Apparatus = AxialCompression,
...
function serpentinite_Raleigh_1965()
    ...
    data = DislocationCreep(;
        ...
        n = 2.8NoUnits,
        A = 1.5848931924611240e-17 * (6.3e-7Pa^(-14 // 5) / s),
        E = 66e3J / mol,
        V = 0m^3 / mol,
        r = 0NoUnits,
        Apparatus = AxialCompression,
...
function strong_diabase_Mackwell_1998()
    ...
    data = DislocationCreep(;
        ...
        n = 4.7NoUnits,
        A = 6.3095734448018912e-29 * (8Pa^(-47 // 10) / s),
        E = 485e3J / mol,
        V = 0m^3 / mol,
        r = 0NoUnits,
        Apparatus = AxialCompression,
...
function mafic_granulite_Wilks_1990()
    ...
    data = DislocationCreep(;
        ...
        n = 4.2NoUnits,
        A = 6.3095734448018909e-26 * (1.4e4Pa^(-21 // 5) / s),
        E = 445e3J / mol,
        V = 0m^3 / mol,
        r = 0NoUnits,
        Apparatus = AxialCompression,
...
function wet_quartzite_Ueda_2008()
    ...
    data = DislocationCreep(;
        ...
        n = 2.3NoUnits,
        A = 1.5848931924611173e-14 * (1 * exp10(-3.5)Pa^(-23 // 10) / s),
        E = 154e3J / mol,
        V = 0m^3 / mol,
        r = 0NoUnits,
        Apparatus = AxialCompression,
...
function granite_Carter_1987()
    ...
    data = DislocationCreep(;
        ...
        n = 3.3NoUnits,
        A = 1.5848931924611240e-20 * (1.0 * exp10(-5.7)Pa^(-33 // 10) / s),
        E = 186.5e3J / mol,
        V = 0m^3 / mol,
        r = 0NoUnits,
        Apparatus = AxialCompression,
...
function plagioclase_An75_Ji_1993()
    ...
    data = DislocationCreep(;
        ...
        n = 3.2NoUnits,
        A = 6.3095734448018914e-20 * (3.27e-4Pa^(-16 // 5) / s),
        E = 238e3J / mol,
        V = 0m^3 / mol,
        r = 0NoUnits,
        Apparatus = AxialCompression,
...
function wet_quartzite_Kirby_1983()
    ...
    data = DislocationCreep(;
        ...
        n = 2.4NoUnits,
        A = 3.9810717055349853e-15 * (1.25e-2Pa^(-12 // 5) / s), # A converted from source units
        E = 160.0e3J / mol,
        V = 0m^3 / mol,
        r = 0NoUnits,
        Apparatus = AxialCompression,
...
function granite_Tirel_2008()
    ...
    data = DislocationCreep(;
        ...
        n = 3.2NoUnits,
        A = 6.3095734448018914e-20 * (1.25e-9Pa^(-16 // 5) / s),
        E = 123e3J / mol,
        V = 0.0m^3 / mol,
        r = 0.0NoUnits,
        Apparatus = AxialCompression,
...
function wet_olivine_Karato_2003()
    ...
    data = DislocationCreep(;
        ...
        n = 3.0NoUnits,
        A = 6.3095734448018909e-26 * ((10^2.9)Pa^(-21 // 5) / s),
        E = 470.0e3J / mol,
        V = 24.0e-6m^3 / mol,
        r = 1.2NoUnits,
        Apparatus = AxialCompression,
...
function wet_clinopyroxene_Chen_2006()
    ...
    data = DislocationCreep(;
        ...
        n = 2.7NoUnits,
        A = 6.3095734448018909e-17 * ((10^6.7)Pa^(-27 // 10) / s),
        E = 670.0e3J / mol,
        V = 0.0m^3 / mol,
        r = 3.0NoUnits,
        Apparatus = AxialCompression,
...
function dry_clinopyroxene_Bystricky_Mackwell_2001()
    ...
    data = DislocationCreep(;
        ...
        n = 4.7NoUnits,
        A = 6.3095734448018912e-29 * ((10^9.8)Pa^(-47 // 10) / s),
        E = 760.0e3J / mol,
        V = 0.0m^3 / mol,
        r = 0.0NoUnits,
        Apparatus = AxialCompression,
...
function wet_jadeit_Orzol_2006()
    ...
    data = DislocationCreep(;
        ...
        n = 3.7NoUnits,
        A = 6.3095734448018912e-23 * ((10^-3.3)Pa^(-37 // 10) / s),
        E = 326.0e3J / mol,
        V = 0.0m^3 / mol,
        r = 0.0NoUnits,
        Apparatus = AxialCompression,
...
function wet_quartzite_Rutter_2004()
    ...
    data = DislocationCreep(;
        ...
        n = 2.97NoUnits,
        A = 1.5135612484362071e-18 * ((10^-4.93)Pa^(-297 // 100) / s),
        E = 242.0e3J / mol,
        V = 0.0m^3 / mol,
        r = 1.0NoUnits,
        Apparatus = AxialCompression,
...
function dry_quartzite_Jaoul_1984()
    ...
    data = DislocationCreep(;
        ...
        n = 2.8NoUnits,
        A = 1.5848931924611240e-17 * ((2.8899e-3)Pa^(-14 // 5) / s),
        E = 184.0e3J / mol,
        V = 0.0m^3 / mol,
        r = 0.0NoUnits,
        Apparatus = AxialCompression,
...
function wet_quartzite_Jaoul_1984()
    ...
    data = DislocationCreep(;
        ...
        n = 1.4NoUnits,
        A = 1.5848931924611240e-17 * ((104.957e-3)Pa^(-14 // 5) / s),
        E = 146.44e3J / mol,
        V = 0.0m^3 / mol,
        r = 0.0NoUnits,
        Apparatus = AxialCompression,
...
function wet_quartzite_Lu_2019()
    ...
    data = DislocationCreep(;
        ...
        n = 4.0NoUnits,
        A = 6.3095734448018910e-41 * ((6.0e-15)Pa^(-67 // 10) / s),
        E = 132.0e3J / mol,
        V = 35.3e-6m^3 / mol,
        r = 2.7NoUnits,
        Apparatus = AxialCompression,
...
function wet_quartzite_Lusk_2021()
    ...
    data = DislocationCreep(;
        ...
        n = 2.1NoUnits,
        A = 1.1481536214968794e-15 * ((10^-7.9)Pa^(-249 // 100) / s),
        E = 94.0e3J / mol,
        V = 1.44e-6m^3 / mol,
        r = 0.2NoUnits,
        Apparatus = AxialCompression,
...
function highP_wet_quartzite_Lusk_2021()
    ...
    data = DislocationCreep(;
        ...
        n = 2.0NoUnits,
        A = 1.5848931924611173e-14 * ((10^-6.36)Pa^(-23 // 10) / s),
        E = 77.0e3J / mol,
        V = 2.59e-6m^3 / mol,
        r = 0.49NoUnits,
        Apparatus = AxialCompression,
...
function high_stress_wet_dunite_Chopra_1981()
    ...
    data = DislocationCreep(;
        ...
        n = 3.35NoUnits,
        A = 7.9432823472427886e-21 * ((10^3.98)Pa^(-67 // 20) / s),
        E = 444.0e3J / mol,
        V = 0.0m^3 / mol,
        r = 0.0NoUnits,
        Apparatus = AxialCompression,
...
function low_stress_wet_dunite_Chopra_1981()
    ...
    data = DislocationCreep(;
        ...
        n = 2.44NoUnits,
        A = 2.2908676527677699e-15 * ((10^3.88)Pa^(-61 // 25) / s),
        E = 386.0e3J / mol,
        V = 0.0m^3 / mol,
        r = 0.0NoUnits,
        Apparatus = AxialCompression,
