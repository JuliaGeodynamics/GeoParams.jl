...
# Peierls Creep ------------------------------------------------
"""
    PeierlsCreep(n = 1.0NoUnits, r = 0.0NoUnits, A = 1.5e-6Pa/s, E = 476.0e3J / mol, V = 6e-6m^3/mol, apparatus = AxialCompression )
...
PeierlsCreep: Name = , n=1.0, q=2.0, o=1.0, TauP=8.5e9 Pa, A=5.7e11 s^-1.0, E=476.0e3 J mol^-1.0, FT=1.7320508075688772, FE=1.1547005383792517, Apparatus=1
```
"""
