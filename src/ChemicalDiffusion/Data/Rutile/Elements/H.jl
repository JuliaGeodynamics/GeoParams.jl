...
function Rt_H_Johnson1975_para_c()
    data = DiffusionData(
        ...
        Ea = 56926.3459528J / mol,
        Ea_1σ = 1929.70664247J / mol,
        Charge = 1,  # charge of the cation
        T_range_min = 125C,
        T_range_max = 750C
    )
...
function Rt_H_Johnson1975_perp_c()
    data = DiffusionData(
        ...
        Ea = 123501.225118J / mol,
        Ea_1σ = 4824.26660617J / mol,
        Charge = 1,  # charge of the cation
        T_range_min = 125C,
        T_range_max = 750C
    )
