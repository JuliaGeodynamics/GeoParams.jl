...
function Melt_Tb_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        Species="Tb",  # element or species being diffused
        ...
        D0=(10^(-4.62))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ=0.89 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea=(175.23)u"kJ/mol",  # activation energy
        Ea_1σ=(19.89)u"kJ/mol",  # uncertainty at 1σ of the activation energy
...
function Melt_Tb_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        log_D0_1σ=0.93 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea=(191.29)u"kJ/mol",  # activation energy
        Ea_1σ=(23.70)u"kJ/mol",  # uncertainty at 1σ of the activation energy
        Charge=3,  # charge of the cation
