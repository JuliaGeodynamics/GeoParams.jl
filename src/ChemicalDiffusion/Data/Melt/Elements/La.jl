...
function Melt_La_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        Species = "La",  # element or species being diffused
        ...
        D0 = (10^(-4.10))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 0.94*2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (182.80)u"kJ/mol",  # activation energy
        Ea_1σ = (20.92)u"kJ/mol",  # uncertainty at 1σ of the activation energy
...
function Melt_La_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        Fluid = "Hydrated",  # Fluid condition (e.g., anhydrous) during the experiment
        D0 = (10^(-4.52))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 0.42*2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (188.03)u"kJ/mol",  # activation energy
        Ea_1σ = (10.71)u"kJ/mol",  # uncertainty at 1σ of the activation energy
        Charge = 3,  # charge of the cation
