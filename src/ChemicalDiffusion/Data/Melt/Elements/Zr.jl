...
"""
function Melt_Zr_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        D0 = (10^(-6.36))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = (1.78)NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (155.16)u"kJ/mol",  # activation energy
        Ea_1σ = (39.92)u"kJ/mol",  # uncertainty at 1σ of the activation energy
...
From Holycross and Watson (2018) (https://doi.org/10.1016/j.gca.2018.04.006).
"""
function Melt_Zr_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        Fluid = "Hydrated",  # Fluid condition (e.g., anhydrous) during the experiment
        D0 = (10^(-5.45))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 0.26*2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (182.38)u"kJ/mol",  # activation energy
        Ea_1σ = (6.55)u"kJ/mol",  # uncertainty at 1σ of the activation energy
        Charge = 3,  # charge of the cation
