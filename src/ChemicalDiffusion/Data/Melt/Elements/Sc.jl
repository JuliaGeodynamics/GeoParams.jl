...
function Melt_Sc_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        D0=(10^(-3.24))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ=1.19 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea=(211.39)u"kJ/mol",  # activation energy
        Ea_1σ=(26.57)u"kJ/mol",  # uncertainty at 1σ of the activation energy
