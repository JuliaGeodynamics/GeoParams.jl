...
function Melt_Pr_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        Species = "Pr",  # element or species being diffused
        ...
        D0 = (10^(-4.95))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 0.91*2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (164.21)u"kJ/mol",  # activation energy
        Ea_1σ = (20.24)u"kJ/mol",  # uncertainty at 1σ of the activation energy
...
function Melt_Pr_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        Ea = (198.74)u"kJ/mol",  # activation energy
        Ea_1σ = (6.96)u"kJ/mol",  # uncertainty at 1σ of the activation energy
        Charge = 3,  # charge of the cation
