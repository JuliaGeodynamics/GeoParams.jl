...
function Melt_Yb_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        Species="Yb",  # element or species being diffused
        ...
        D0=(10^(-5.23))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ=0.84 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea=(164.47)u"kJ/mol",  # activation energy
        Ea_1σ=(18.78)u"kJ/mol",  # uncertainty at 1σ of the activation energy
...
function Melt_Yb_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        Fluid="Hydrated",  # Fluid condition (e.g., anhydrous) during the experiment
        D0=(10^(-4.58))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ=0.41 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea=(189.99)u"kJ/mol",  # activation energy
        Ea_1σ=(10.28)u"kJ/mol",  # uncertainty at 1σ of the activation energy
        Charge=3,  # charge of the cation
