...
function Melt_Th_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        Species="Th",  # element or species being diffused
        ...
        D0=(10^(-5.10))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ=1.11 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea=(176.71)u"kJ/mol",  # activation energy
        Ea_1σ=(24.86)u"kJ/mol",  # uncertainty at 1σ of the activation energy
