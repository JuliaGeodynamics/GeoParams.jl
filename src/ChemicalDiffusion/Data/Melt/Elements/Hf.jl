...
function Melt_Hf_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        D0=(10^(-3.52))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ=(0.20 * 2.303)NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea=(231.09)u"kJ/mol",  # activation energy
        Ea_1σ=(5.31)u"kJ/mol",  # uncertainty at 1σ of the activation energy
