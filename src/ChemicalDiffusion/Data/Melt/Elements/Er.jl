...
"""
function Melt_Er_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        Species = "Er",  # element or species being diffused
        ...
        D0 = (10^(-3.39))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 1.49 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (205.25)u"kJ/mol",  # activation energy
        Ea_1σ = (33.36)u"kJ/mol",  # uncertainty at 1σ of the activation energy
...
From Holycross and Watson (2018) (https://doi.org/10.1016/j.gca.2018.04.006).
"""
function Melt_Er_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        log_D0_1σ = 0.27 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (185.92)u"kJ/mol",  # activation energy
        Ea_1σ = (6.88)u"kJ/mol",  # uncertainty at 1σ of the activation energy
        Charge = 3,  # charge of the cation
