...
"""
function Melt_Y_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        Species = "Y",  # element or species being diffused
        ...
        D0 = (10^(-5.09))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 1.01 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (165.74)u"kJ/mol",  # activation energy
        Ea_1σ = (22.51)u"kJ/mol",  # uncertainty at 1σ of the activation energy
...
From Holycross and Watson (2018) (https://doi.org/10.1016/j.gca.2018.04.006).
"""
function Melt_Y_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        Fluid = "Hydrated",  # Fluid condition (e.g., anhydrous) during the experiment
        D0 = (10^(-4.66))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 0.13 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (188.31)u"kJ/mol",  # activation energy
        Ea_1σ = (3.42)u"kJ/mol",  # uncertainty at 1σ of the activation energy
        Charge = 3,  # charge of the cation
