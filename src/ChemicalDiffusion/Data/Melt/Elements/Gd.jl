...
"""
function Melt_Gd_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        Species = "Gd",  # element or species being diffused
        ...
        D0 = (10^(-4.06))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 0.97*2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (187.25)u"kJ/mol",  # activation energy
        Ea_1σ = (21.66)u"kJ/mol",  # uncertainty at 1σ of the activation energy
...
From Holycross and Watson (2018) (https://doi.org/10.1016/j.gca.2018.04.006).
"""
function Melt_Gd_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        Fluid = "Hydrated",  # Fluid condition (e.g., anhydrous) during the experiment
        D0 = (10^(-4.57))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 0.41*2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (188.24)u"kJ/mol",  # activation energy
        Ea_1σ = (10.74)u"kJ/mol",  # uncertainty at 1σ of the activation energy
        Charge = 3,  # charge of the cation
