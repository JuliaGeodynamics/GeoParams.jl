...
"""
function Melt_Nb_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        D0 = (10^(-4.91))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = (2.42)NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (179.45)u"kJ/mol",  # activation energy
        Ea_1σ = (54.40)u"kJ/mol",  # uncertainty at 1σ of the activation energy
...
From Holycross and Watson (2018) (https://doi.org/10.1016/j.gca.2018.04.006).
"""
function Melt_Nb_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        Fluid = "Hydrated",  # Fluid condition (e.g., anhydrous) during the experiment
        D0 = (10^(-4.03))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 0.66*2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (214.53)u"kJ/mol",  # activation energy
        Ea_1σ = (16.85)u"kJ/mol",  # uncertainty at 1σ of the activation energy
        Charge = 3,  # charge of the cation
