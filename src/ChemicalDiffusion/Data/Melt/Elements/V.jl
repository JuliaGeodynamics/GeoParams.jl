...
function Melt_V_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        Species="V",  # element or species being diffused
        ...
        D0=(10^(-2.67))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ=1.29 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea=(222.36)u"kJ/mol",  # activation energy
        Ea_1σ=(28.85)u"kJ/mol",  # uncertainty at 1σ of the activation energy
...
function Melt_V_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        log_D0_1σ=0.23 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea=(184.99)u"kJ/mol",  # activation energy
        Ea_1σ=(5.84)u"kJ/mol",  # uncertainty at 1σ of the activation energy
        Charge=3,  # charge of the cation
