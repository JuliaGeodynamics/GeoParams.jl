...
"""
function Melt_Eu_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        Species="Eu",  # element or species being diffused
        ...
        D0=(10^(-4.17))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ=0.39 * 2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea=(187.11)u"kJ/mol",  # activation energy
        Ea_1σ=(9.81)u"kJ/mol",  # uncertainty at 1σ of the activation energy
