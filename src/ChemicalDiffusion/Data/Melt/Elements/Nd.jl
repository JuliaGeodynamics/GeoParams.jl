...
"""
function Melt_Nd_Holycross2018_rhyolitic_highH2O()
    data = DiffusionData(
        ...
        Species = "Nd",  # element or species being diffused
        ...
        D0 = (10^(-3.89))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 1.05*2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (188.87)u"kJ/mol",  # activation energy
        Ea_1σ = (23.48)u"kJ/mol",  # uncertainty at 1σ of the activation energy
...
From Holycross and Watson (2018) (https://doi.org/10.1016/j.gca.2018.04.006).
"""
function Melt_Nd_Holycross2018_rhyolitic_mediumH2O()
    data = DiffusionData(
        ...
        Fluid = "Hydrated",  # Fluid condition (e.g., anhydrous) during the experiment
        D0 = (10^(-4.78))u"m^2 / s",  # pre-exponential factor (log10(-3.21) in the original paper
        log_D0_1σ = 0.43*2.303NoUnits,  # uncertainty reported as log10(D0) in the original paper
        Ea = (181.97)u"kJ/mol",  # activation energy
        Ea_1σ = (10.89)u"kJ/mol",  # uncertainty at 1σ of the activation energy
        Charge = 3,  # charge of the cation
