...
From Bloch et al. (2020) (https://doi.org/10.1093/petrology/egaa055) combined with data from Tirone et al. (2005) and Bloch et al. (2015).
"""
function Grt_REE_Bloch2020_fast()
    data = DiffusionData(
        ...
        D0 = -(10.24*2.303)m^2 / s,  # pre-exponential factor
        D0_1σ = (0.21*2.303)m^2 / s,  # pre-exponential factor
        Ea = 221057u"J/mol",  # activation energy
        Ea_1σ = 4284u"J/mol",  # uncertainty at 1σ of the activation energy
...
function Grt_REE_Bloch2020_slow()
    data = DiffusionData(
        ...
        Buffer = "QFM",  # Buffer condition (e.g., NNO) during the experiment
        Fluid = "Anhydrous",  # Fluid condition (e.g., anhydrous) during the experiment
        D0 = -(9.28*2.303)u"m^2 / s",  # pre-exponential factor
        D0_1σ = (0.21*2.303)u"m^2 / s",  # pre-exponential factor
        Ea = 265200u"J/mol",  # activation energy
        Ea_1σ = 38540u"J/mol",  # uncertainty at 1σ of the activation energy
        ΔV = (10800e-9)u"m^3 / mol",  # activation volume
