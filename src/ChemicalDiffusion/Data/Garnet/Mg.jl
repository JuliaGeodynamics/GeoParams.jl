...
Diffusion data of Mg in garnet. Calibrated between 1100-1480°C in the C-O2 system. From Chakraborty and Ganguly (1992) (https://doi.org/10.1007/BF00296579) combined with data from Loomis et al. (1985) (https://doi.org/10.1007/BF00373040).
"""
function Grt_Mg_Chakraborty1992()
    data = DiffusionData(
        ...
        D0              = 1.1*1e-3cm^2/s,  # pre-exponential factor
        D0_2σ           = 0.0m^2/s,  # uncertainty at 2σ of the pre-exponential factor
        Ea              = 67997u"cal/mol",  # activation energy
        Ea_2σ           = 17946u"cal/mol",  # uncertainty at 2σ of the activation energy
        ΔV              = 5.3cm^3/mol,  # activation volume
        ΔV_2σ           = 6.0cm^3/mol,  # uncertainty at 2σ of the activation volume
