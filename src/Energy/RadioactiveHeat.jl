...
function compute_radioactive_heat!(
    Hr::AbstractArray{_T,N}, s::ConstantRadioactiveHeat{_T}; kwargs...
) where {_T,N}
    @unpack_val H_r = s
...
function compute_radioactive_heat!(
    Hr::AbstractArray{_T,N},
    s::ExpDepthDependentRadioactiveHeat{_T};
...
for myType in (:ExpDepthDependentRadioactiveHeat, :ConstantRadioactiveHeat)
    @eval begin
        ...
        function compute_radioactive_heat!(
            ...
            return compute_radioactive_heat!(H, s; args...)
        end
    end
end
