...
module MaterialParameters
    ...
    function set_gravity(Gravity::Nothing, Density::AbstractMaterialParam)
        return GravitationalAcceleration.ConstantGravity()
    end
    ...
    ConvField(::Nothing, fieldname::Symbol; maxAllowedFields = 1.0e6) = ()
    ConvField(field::AbstractMaterialParam, fieldname::Symbol; maxAllowedFields = 1.0e6) = (field,)
    function ConvField(field::NTuple{N, Any}, fieldname::Symbol; maxAllowedFields = 1.0e6) where {N}
