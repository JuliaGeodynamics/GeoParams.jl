...
@testset "StressComputations" begin
    ...
    case_5 = (
        (1.0, -1.1, 2.3, 3.0 .* Tu, 4.1 .* Tu, 5.3 .* Tu),
        (1.0, -1.0, 2.0, 2.1 .* Tu, 3.2 .* Tu, 4.3 .* Tu),
        (1, 1, 1, TuI, TuI, TuI),
        1.0,
    )             # 3D staggered ε, τ_o, phase, P_o around center points
    case_6 = (
        (1.0 .* Tu, -1.1 .* Tu, 2.3 .* Tu, 3.0, 4.1, 5.3),
        (1.0 .* Tu, -1.0 .* Tu, 2.0 .* Tu, 2.1, 3.2, 4.3),
        (TuI, TuI, TuI, 1, 1, 1),
        1.0,
    )             # 3D staggered ε, τ_o, phase, P_o around vertex points
